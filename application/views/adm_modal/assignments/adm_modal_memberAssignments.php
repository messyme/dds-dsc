    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" action="<?= base_url() ?>pages/Assignments/add_data_memberusecase">
                    <div class="form-group">
                        <label class="required">Name</label>
                        <select class="select2" id="nik" name="multinik[]" multiple="multiple" required="required" data-placeholder="Choose Name Member" style="width: 100%;">
                            <?php
                    ...
                    <button type="submit" class="btn btn-success btn-block" id="submit">Add Data Member in Assignments</button>
                </form>
            </div>
            <!-- eof body -->
        </div>
...
?>
    <div class="modal fade" id="deleteModal<?= $mu->id_member_usecase ?>"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <a id="btn-delete" class="btn btn-danger" href="<?= base_url() ?>pages/Assignments/delete_data_memberusecase/<?= $mu->id_member_usecase ?>">Delete</a>
                </div>
            </div>
        </div>
    </div>

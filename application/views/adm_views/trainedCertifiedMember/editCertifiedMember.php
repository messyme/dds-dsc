  ...
  <body>
    <div class="container p-4" id="bg-template">
        ...
        <form role="form" method="post" action="<?= base_url() ?>pages/MemberSkills/updateDataCertifiedMember" enctype="multipart/form-data">
            ...
            <div class="form-group ml-auto">
                ...
                <input class="form-control" type="text" id="nama_sertifikasi" name="nama_sertifikasi" placeholder="Example: Big Data Analytic" required="required" value="<?= $member_select[0]->nama_sertifikasi; ?>">
            </div>
            ...
            <div class="d-flex flex-row-reverse">
                ...
                <div style="margin-right: 30px;">
                    <a href="<?= base_url(); ?>pages/MemberSkills/certified_member" type="button" class="btn btn-danger" role="button">Cancel</a>  
                </div>
            </div>

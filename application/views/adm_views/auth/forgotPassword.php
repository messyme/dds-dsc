  ...
  <div class="container animate__animated animate__rubberBand">
    <div class="row justify-content-center align-items-center">
      <div class="bg-login p-4">
        ...
        <h4 class="text-center mt-2">Did you forgot your password?</h4>
        <?php
        ...
        <p class="text-center mb-4">
          Enter your email address you're using for your account below and we will send you the password
        </p>
        <form method="post" action="<?= base_url() ?>pages/ForgotPassword/requestforgotpassword">
          ...
          <button type="submit" class="btn btn-block btn-outline-primary mb-3">Request Password</button>
          <div>
            <p><a href="<?= base_url() ?>pages/Login">Back to Sign In</a></p>
          </div>
        </form>
      </div>
    </div>

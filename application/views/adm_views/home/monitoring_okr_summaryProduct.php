  ...
  <body>
        ...
        <div class="container-fluid p-4" id="bg-template-graph">
            ...
            <div class="row justify-content-center align-items-center text-center">
                <a class="monitoring-nav col-sm-2 col-md-2 target" href="<?= base_url() ?>pages/Home/okr_summary_product">OKR Product</a>
                <a class="monitoring-nav col-sm-2 col-md-2" href="<?= base_url() ?>pages/Home/okr_summary_DSC">OKR DSC</a>
                <a class="monitoring-nav col-sm-2 col-md-2" href="<?= base_url() ?>pages/Home/okr_summary_member">OKR Member</a>
            </div>
